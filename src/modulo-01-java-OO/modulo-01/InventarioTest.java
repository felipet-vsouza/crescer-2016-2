...
public class InventarioTest
{
    ...
    @Test
    public void inventarioOrdenaOitoItensDescendentemente() {
        Inventario inv = new Inventario();
        inv.adicionarItem(new Item("Peneira", 20));
        inv.adicionarItem(new Item("Martelo", 2));
        inv.adicionarItem(new Item("Concha", 28));
        ...
        assertEquals(60, inv.getLista().get(0).getQuantidade());
        assertEquals(59, inv.getLista().get(1).getQuantidade());
        assertEquals(33, inv.getLista().get(2).getQuantidade());
        assertEquals(28, inv.getLista().get(3).getQuantidade());
        assertEquals(20, inv.getLista().get(4).getQuantidade());
        assertEquals(6, inv.getLista().get(5).getQuantidade());
        assertEquals(2, inv.getLista().get(6).getQuantidade());
        assertEquals(1, inv.getLista().get(7).getQuantidade());
    }
    
    @Test
    public void inventarioOrdenaOitoItensComQuantidadesIguaisDescendentemente() {
        Inventario inv = new Inventario();
        inv.adicionarItem(new Item("Peneira", 12));
        inv.adicionarItem(new Item("Martelo", 12));
        inv.adicionarItem(new Item("Concha", 12));
